...
public class RBTreeFunctions
//implements RBTreeFunctions
{
   ...
   // @Override
	...
	if (sibling.color == _BLACK && ((sibling.right!=null && sibling.right.color == _RED) || (sibling.left!=null && sibling.left.color == _RED))){
	    ...
	    if(sibling.parent.left == sibling){
		if(sibling.right!=null && sibling.right.color == _RED&&((sibling.left!=null&&sibling.left.color== _BLACK)||sibling.left==null)){
		...
		if(sibling.left!=null && sibling.left.color == _RED&&((sibling.right!=null&&sibling.right.color== _BLACK)||sibling.right==null)){
